insert into profile values('0001','TESZT_USER_1','teszt1@gmail.com',NULL,DATE '2021-02-01','DELETED',NULL);
insert into profile values('0002','TESZT_USER_2','teszt2@gmail.com',NULL,DATE '2021-02-19','ACTIVE',NULL);
insert into profile values('0003','TESZT_USER_3','teszt3@gmail.com','36301234556',DATE '2021-06-30','INACTIVE',NULL);
insert into profile values('0004','TESZT_USER_4','teszt4@gmail.com',NULL,DATE '2021-08-01','ACTIVE',NULL);
insert into profile values('0005','TESZT_USER_5','teszt5@gmail.com','30702456666',DATE '2021-09-26','ACTIVE',NULL);

insert into realtor values('A0001','GÉZA',NULL,'TESZT',NULL,DATE '2006-05-02',NULL,'teszt.geza@ingatlanos.com',NULL,DATE '2015-03-21');
insert into realtor values('A0002','ESZTER',NULL,'TESZTER',NULL,DATE '2008-10-01','36201237889',NULL,NULL,NULL);
insert into realtor values('A0003','BÉLA','KÁROLY','PRÓBA',0.12,DATE '2019-04-30',NULL,'b.proba@gmail.com',NULL,NULL);
insert into realtor values('A0004','GIZI',NULL,'TESZT',0.08,DATE '2020-06-21',NULL,NULL,NULL,NULL);
...
insert into property values('P0002',DATE '2021-01-06',NULL,'ACTIVE','KI');
insert into property values('P0003',DATE '2021-06-08',NULL,'ACTIVE','EL');
insert into property values('P0004',DATE '2021-08-09',NULL,'ACTIVE','EL');
insert into property values('P0005',DATE '2021-09-26',NULL,'INACTIVE','KI');
...
insert into property_location values('P0001','1034','BUDAPEST','BÉCSI','ÚT','60',NULL,'3','41');
insert into property_location values('P0002','5241','ABÁDSZALÓK','ADY ENDER','UTCA','1',NULL,NULL,NULL);
insert into property_location values('P0004','9010','GYÕR',NULL,NULL,NULL,NULL,NULL,NULL);
insert into property_location values('P0005','1145','BUDAPEST','ÚJVILÁG','UTCA',NULL,NULL,NULL,NULL);
...
insert into property_description values('P0001','LAK','LAKP','UJSZ','UDV','E','ELEKT',NULL,'OSSZK','NTET','EGY',3,2.3,NULL,'I',NULL,NULL,NULL,32000000,125,2,2,1,'KORF',NULL,NULL,NULL,NULL,'N',NULL,'VAN','VAN','VAN','VAN');
insert into property_description values('P0002','HAZ','CSHAZ','FELUJ',NULL,'D','TAVFU',NULL,'KOMF',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'I',52000000,100,1,3,2,NULL,NULL,2,'I','I',NULL,NULL,'UTC','UTC','UTC','UTC');
insert into property_description values('P0003','TELEK','KULTE',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,20000000,NULL,NULL,NULL,NULL,NULL,4000,NULL,NULL,NULL,NULL,NULL,'BELUL','BELUL','BELUL','BELUL');
insert into property_description values('P0004','GAR','GARON',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,19000000,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'NINCS','NINCS','NINCS','NINCS');
insert into property_description values('P0005','LAK','ZSALU','UJEP','UTCA','DNY','MENNY','KOZT','DUPK','ZARO','KESE',NULL,NULL,NULL,NULL,'I','I',NULL,75000000,160,3,1,2,NULL,NULL,NULL,NULL,NULL,'N',NULL,'VAN','VAN','VAN','VAN');

insert into admin values('X0001','0001',NULL,'FULL_HIRDETES',DATE '2021-02-01',DATE '2021-10-01');
insert into admin values('X0002',NULL,'A0001','REALTOR',DATE '2021-02-01',NULL);
insert into admin values('X0003',NULL,'A0002','REALTOR',DATE '2021-02-01',NULL);
insert into admin values('X0004','0002',NULL,'FULL_HIRDETES',DATE '2021-02-19',NULL);
insert into admin values('X0005',NULL,'A0003','REALTOR',DATE '2021-05-10',NULL);
insert into admin values('X0006','0003',NULL,'FULL_HIRDETES',DATE '2021-06-30',NULL);
insert into admin values('X0007','0004',NULL,'FULL_HIRDETES',DATE '2021-08-01',NULL);
insert into admin values('X0008','0005',NULL,'FULL_HIRDETES',DATE '2021-09-26',NULL);
insert into admin values('X0009',NULL,'A0004','REALTOR',DATE '2021-09-28',NULL);
